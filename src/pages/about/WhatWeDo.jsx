...
// // const WhatWeDo = () => {
// //   return (
// //     <div className="flex flex-col md:flex-row gap-8 my-12 mx-16 items-center">
      
// //       {/* Left Side - Image */}
// //       <div className="w-full mt-8 md:w-2/5 flex justify-center">
...
// //         <h2 className="text-3xl font-bold text-[#b5824e] mb-6">What We Do</h2>
