      ...
      >
        <div className="max-w-3xl">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-3 text-white font-semibold px-8 py-4 border-2 border-white rounded-full hover:bg-white hover:text-navy-900 transition-colors duration-300"
          >
