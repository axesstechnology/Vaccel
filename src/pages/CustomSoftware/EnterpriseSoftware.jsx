    ...
    <div className="bg-gray-50 min-h-screen mb-4 p-4  md:p-8 ">
      <div className="max-w-7xl mx-auto pl-24 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1">
          <h1 className="text-3xl md:text-3xl font-bold text-[#b5824e] mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex items-center gap-4 bg-white p-4 rounded-lg shadow">
              <div className="flex-shrink-0">
                <svg className="w-8 h-8 text-[#b5824e]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
